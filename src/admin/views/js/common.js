        ...
        init: function() {
            ...
            $this.find("li").has("ul").children("a").on("click" + "." + pluginName, function(e) {
                ...
                if (obj.settings.doubleTapToGo) {
                    ...
                    if (obj.doubleTapToGo($(this)) && $(this).prop("href") !== "#" && $(this).prop("href") !== "") {
                        e.stopPropagation();
...
function autosave(act){
    ...
    if (act == 3 || act == 4){
        ...
        var allow_remark = $("#page_options #allow_remark").is(":checked") ? 'y' : 'n';
        var is_blank = $("#page_options #is_blank").is(":checked") ? 'y' : 'n';
        ...
        var top = $("#post_options #top").is(":checked") ? 'y' : 'n';
        var sortop = $("#post_options #sortop").is(":checked") ? 'y' : 'n';
        var allow_remark = $("#post_options #allow_remark").is(":checked") ? 'y' : 'n';
        var allow_tb = $("#post_options #allow_tb").is(":checked") ? 'y' : 'n';
...
function selectAllToggle(){
    $("#select_all").toggleClick(function () {$(".ids").prop("checked", true);},function () {$(".ids").removeProp("checked");});
}