...
function pagination($count, $perlogs, $page, $url, $anchor = '') {
    ...
    if($prepg) {
        $re .=" <a class=\"prev page-numbers\" href=\"$url$prepg$anchor\">Previous page</a> ";
        if($page - 2 > 1) {
            $re .= " <a class=\"page-numbers\" href=\"$urlHome$anchor\"><span class=\"meta-nav screen-reader-text\">Page </span>1</a> ";
            if($page - 2 > 2) $re .= " <span class=\"page-numbers dots\">…</span> ";
        }
    }
    ...
    for ($i = $page - 2; $i <= $page + 2 && $i <= $pnums; $i++) {
        if ($i > 0) {
            if ($i == $page) {
                $re .= " <span aria-current=\"page\" class=\"page-numbers current\"><span class=\"meta-nav screen-reader-text\">Page </span>$i</span> ";
            } elseif ($i == 1) {
                $re .= " <a class=\"page-numbers\" href=\"$urlHome$anchor\"><span class=\"meta-nav screen-reader-text\">Page </span>$i</a> ";
            } else {
                $re .= " <a class=\"page-numbers\" href=\"$url$i$anchor\"><span class=\"meta-nav screen-reader-text\">Page </span>$i</a> ";
            }
        }
    }
    if($nextpg) {
        if($page + 2 < $pnums - 1) $re .= " <span class=\"page-numbers dots\">…</span> ";
        if($page + 2 < $pnums) $re .= " <a class=\"page-numbers\" href=\"$url$pnums$anchor\"><span class=\"meta-nav screen-reader-text\">Page </span>$pnums</a> ";
        $re .=" <a class=\"next page-numbers\" href=\"$url$nextpg$anchor\">Next page</a> ";
    }
    return $re;
}
